...
public class MainRunner extends JFrame
{
    ...
    private boolean helpClicked, gamClicked, paused, onUpgrades, onCharS,onInt;
    ...
    private int movespeed, movesAvailable;
    ...
    {
        private JButton pauseButton, gameOverB;
        private TipReader tr;
        ...
        public void actionPerformed(ActionEvent evt)
        {
            ...
            else if(test == toUpgrades)
            {
                paused = false;
                onUpgrades = true;
            }
            else if(test == gameOverB)
            {
                System.out.println("1");
                gameOver = true;
            }
